...
public class ButtonLabels {
    ...
    public final static String SHOW_SELECTED_COMPANY = "Show details for selected company";
    public final static String ADD_NEW_COMPANY = "Add a new company";
    ...
    public final static String REMOVE_SELECTED_JOBAD = "Remove selected add";
